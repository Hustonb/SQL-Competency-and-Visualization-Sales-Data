...
To run the SQL scripts for yourself, download the two scripts in this repository. Run PopulateTables.SQL in order to create the tables and fill them with data. Then run the different queries in the ALLEDA.sql script to gain insight into the data.
